...
<head>
    ...
    <title>{{ config('app.name', 'KMKB') }}</title>
                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            ...
                            @if(Auth::user()->hasRole('mutu') || Auth::user()->hasRole('admin'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('pathways.index') }}">{{ __('Pathways') }}</a>
                                </li>
                            @endif
                            ...
                            @if(Auth::user()->hasRole('admin'))
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('audit-logs.index') }}">{{ __('Audit Logs') }}</a>
                                </li>
                            @endif
                        @endauth
                    </ul>
