                    ...
                    <div class="mb-0.5">
                        ...
                        <div x-show="!collapsed && isGroupOpen('data-input')" class="ml-8 mt-0.5 space-y-0.5">
                            ...
                            <a href="{{ route('employees.index') }}" 
                               class="flex items-center px-3 py-1.5 text-sm rounded-lg transition-colors {{ request()->routeIs('employees.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900' }}">
                                <span class="truncate">Human Resources</span>
                            </a>
                            <!-- Household Expenses (Biaya Alat Rumah Tangga) -->
                            <div class="mt-0.5" x-show="!collapsed">
                                <button @click="toggleGroup('household')"
                                        class="w-full flex items-center justify-between px-3 py-1.5 text-sm rounded-lg transition-colors {{ request()->routeIs('household-items.*') || request()->routeIs('household-expenses.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900' }}">
                                ...
                                <div x-show="isGroupOpen('household')" class="ml-4 mt-0.5 space-y-0.5">
                                    <a href="{{ route('household-items.index') }}"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors {{ request()->routeIs('household-items.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900' }}">
