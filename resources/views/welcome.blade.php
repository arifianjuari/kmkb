        ...
        <nav class="fixed w-full z-50 top-0 transition-all duration-300 bg-white/80 backdrop-blur-md border-b border-slate-200/60">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="hidden md:flex items-center space-x-4">
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/dashboard') }}" class="text-sm font-medium text-slate-700 hover:text-indigo-600 transition-colors">Dashboard</a>
                            @else
            ...
            <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-slate-100 absolute w-full shadow-xl">
                <div class="px-6 py-6 space-y-4">
                    ...
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="block text-base font-medium text-indigo-600">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}" class="block text-base font-medium text-slate-700">Log in</a>
                            <a href="{{ route('register') }}" class="block w-full px-6 py-3 text-center text-base font-medium text-white bg-indigo-600 rounded-lg">Get Started</a>
                        @endauth
                    @endif
                </div>
            </div>
            ...
            <div class="max-w-5xl mx-auto px-6 lg:px-8">
                <div class="bg-gradient-to-r from-indigo-600 via-indigo-700 to-blue-600 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden shadow-2xl shadow-indigo-500/40">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-bold text-indigo-700 bg-white hover:bg-indigo-50 rounded-full shadow-xl border-none transition-all duration-200 transform hover:-translate-y-1">
                                Kembali ke Dashboard
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-bold text-indigo-700 bg-white hover:bg-indigo-50 rounded-full shadow-xl border-none transition-all duration-200 transform hover:-translate-y-1">
                                Mulai Sekarang
                            </a>
