                ...
                <form action="{{ route('jkn-cbg-codes.update', $jknCbgCode) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="text" id="code" name="code" value="{{ old('code', $jknCbgCode->code) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('code') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            @error('code')
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="text" id="name" name="name" value="{{ old('name', $jknCbgCode->name) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('name') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            @error('name')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 mt-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <input type="text" id="grouping_version" name="grouping_version" value="{{ old('grouping_version', $jknCbgCode->grouping_version) }}" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('grouping_version') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 mt-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="number" id="tariff" name="tariff" step="any" value="{{ old('tariff', $jknCbgCode->tariff) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('tariff') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            @error('tariff')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="sm:col-span-3 flex items-end">
                            <div class="flex items-center">
                                ...
                                <input id="is_active" name="is_active" type="checkbox" class="h-4 w-4 text-biru-dongker-800 focus:ring-biru-dongker-700 border-gray-300 rounded" value="1" {{ old('is_active', $jknCbgCode->is_active) ? 'checked' : '' }}>
