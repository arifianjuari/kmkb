...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-900">{{ __('Import Driver Statistics') }}</h2>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                <h3 class="text-lg leading-6 font-medium text-gray-900">{{ __('Import Driver Statistics from Excel') }}</h3>
                <p class="mt-1 text-sm text-gray-500">{{ __('Upload Excel file with format: Cost Center Code, Allocation Driver Name, Value') }}</p>
            </div>
                        ...
                        <div class="col-span-12">
                            ...
                            <div class="mt-1">
                                ...
                                <p class="mt-2 text-sm text-gray-500">
                                    {{ __('Format file: Cost Center Code | Allocation Driver Name | Value') }}<br>
