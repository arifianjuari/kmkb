    ...
    <div class="px-4 py-6 sm:px-0">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('driver-statistics.edit', $driverStatistic) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                    {{ __('Edit') }}
                </a>
