    ...
    <div>
        <div class="flex justify-between items-center mb-6 flex-wrap gap-4">
            ...
            <div class="flex items-center space-x-2">
                ...
                <a href="{{ route('driver-statistics.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-biru-dongker-800 hover:bg-biru-dongker-900">
