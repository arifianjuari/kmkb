                ...
                <form action="{{ route('tariff-simulation.simulate') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-12">
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <select id="version_label" name="version_label" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="global_margin" name="global_margin" value="{{ old('global_margin', $globalMargin * 100) }}" step="0.01" min="0" max="1000" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                @error('global_margin')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="jasa_sarana" name="jasa_sarana" value="{{ old('jasa_sarana', $jasaSarana) }}" step="0.01" min="0" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                @error('jasa_sarana')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="jasa_pelayanan" name="jasa_pelayanan" value="{{ old('jasa_pelayanan', $jasaPelayanan) }}" step="0.01" min="0" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
