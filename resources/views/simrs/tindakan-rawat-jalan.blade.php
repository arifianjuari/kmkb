    ...
    <div>
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-2">
                <div class="relative">
                    <input type="text" id="search-tindakan-jalan" placeholder="Cari kode atau nama tindakan..." class="block w-full rounded-md border-gray-300 shadow-sm focus:border-biru-dongker-700 focus:ring-biru-dongker-700 sm:text-sm pl-10">
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <input type="checkbox" id="select-all-jalan" class="rounded border-gray-300 text-biru-dongker-800 shadow-sm focus:border-biru-dongker-500 focus:ring focus:ring-biru-dongker-400 focus:ring-opacity-50">
                            </th>
