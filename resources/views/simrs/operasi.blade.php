        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <div class="relative rounded-md shadow-sm">
                    <input type="text" id="search-input" class="block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-biru-dongker-800 sm:text-sm sm:leading-6" placeholder="Cari kode atau nama operasi...">
                    <div class="absolute inset-y-0 right-0 flex items-center">
                        <button id="search-button" class="h-full rounded-md border-0 bg-transparent py-0 pl-2 pr-3 text-gray-500 focus:ring-2 focus:ring-inset focus:ring-biru-dongker-800">
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <input type="checkbox" id="select-all-checkbox" class="rounded border-gray-300 text-biru-dongker-800 shadow-sm focus:border-biru-dongker-500 focus:ring focus:ring-biru-dongker-400 focus:ring-opacity-50">
                            </th>
...
<script>
    ...
    function createPageButton(pageNumber, container) {
        ...
        button.className = `relative inline-flex items-center px-4 py-2 text-sm font-semibold ${pageNumber === currentPage ? 'z-10 bg-biru-dongker-800 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-biru-dongker-800' : 'text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0'} relative inline-flex items-center px-4 py-2 text-sm font-semibold focus:z-20 focus:outline-offset-0`;
