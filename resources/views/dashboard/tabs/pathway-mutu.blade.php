                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    <template x-for="(item, index) in pathwayMutu.summary" :key="index">
                        <tr>
                            ...
                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200" x-text="item.compliance + '%'"></td>
                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200" x-text="item.losStandar + ' hari'"></td>
                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200" x-text="item.losActual + ' hari'"></td>
                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200" x-text="'Rp ' + formatNumber(item.avgCost)"></td>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    <template x-for="(item, index) in pathwayMutu.nonCompliantSteps" :key="index">
                        <tr>
                            <td class="px-6 py-2 text-sm text-gray-900 dark:text-gray-200" x-text="item.pathway"></td>
                            <td class="px-6 py-2 text-sm text-gray-900 dark:text-gray-200" x-text="item.stepName"></td>
                            <td class="px-6 py-2 whitespace-nowrap text-sm text-red-600" x-text="item.nonCompliancePercent + '%'"></td>
                            <td class="px-6 py-2 whitespace-nowrap">
                    ...
                    <tr x-show="pathwayMutu.nonCompliantSteps.length === 0">
                        <td colspan="4" class="px-6 py-2 text-center text-gray-500 dark:text-gray-400">Tidak ada data</td>
                    </tr>
                </tbody>
            </table>
        </div>
