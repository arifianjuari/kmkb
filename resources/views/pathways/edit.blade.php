            ...
            <div class="px-4 py-5 sm:p-6">
                <form action="{{ route('pathways.update', $pathway) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1">
                            <input type="text" id="name" name="name" value="{{ old('name', $pathway->name) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('name') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        </div>
                        @error('name')
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1">
                            <textarea id="description" name="description" rows="3" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('description') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('description', $pathway->description) }}</textarea>
                        </div>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" id="diagnosis_code" name="diagnosis_code" value="{{ old('diagnosis_code', $pathway->diagnosis_code) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('diagnosis_code') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" id="version" name="version" value="{{ old('version', $pathway->version) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('version') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            @error('version')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2 mt-6">
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="date" id="effective_date" name="effective_date" value="{{ old('effective_date', $pathway->effective_date->format('Y-m-d')) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('effective_date') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
