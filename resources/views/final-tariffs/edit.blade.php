                ...
                <form action="{{ route('final-tariffs.update', $finalTariff) }}" method="POST" id="tariffForm">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-12">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="sk_number" name="sk_number" value="{{ old('sk_number', $finalTariff->sk_number) }}" required maxlength="100" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700">
                                @error('sk_number')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="base_unit_cost" name="base_unit_cost" value="{{ old('base_unit_cost', $finalTariff->base_unit_cost) }}" step="0.01" min="0" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700" onchange="calculateTariff()">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="margin_percentage" name="margin_percentage" value="{{ old('margin_percentage', $finalTariff->margin_percentage * 100) }}" step="0.01" min="0" max="1000" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700" onchange="calculateTariff()">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="jasa_sarana" name="jasa_sarana" value="{{ old('jasa_sarana', $finalTariff->jasa_sarana) }}" step="0.01" min="0" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700" onchange="calculateTariff()">
                                @error('jasa_sarana')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="jasa_pelayanan" name="jasa_pelayanan" value="{{ old('jasa_pelayanan', $finalTariff->jasa_pelayanan) }}" step="0.01" min="0" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700" onchange="calculateTariff()">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="final_tariff_price" name="final_tariff_price" value="{{ old('final_tariff_price', $finalTariff->final_tariff_price) }}" step="0.01" min="0" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="date" id="effective_date" name="effective_date" value="{{ old('effective_date', $finalTariff->effective_date->format('Y-m-d')) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="date" id="expired_date" name="expired_date" value="{{ old('expired_date', $finalTariff->expired_date ? $finalTariff->expired_date->format('Y-m-d') : '') }}" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700">
                                @error('expired_date')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
