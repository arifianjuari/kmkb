    ...
    <div class="px-4 py-6 sm:px-0">
        <div class="flex justify-between items-center mb-6 flex-wrap gap-4">
            ...
            <div class="flex items-center space-x-2">
                ...
                <a href="{{ route('final-tariffs.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
            ...
            <div class="px-4 py-5 sm:p-6">
                <form method="GET" action="{{ route('final-tariffs.index') }}" class="grid grid-cols-1 gap-4 md:grid-cols-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="sk_number" name="sk_number" value="{{ $skNumber }}" placeholder="{{ __('SK...') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-sm">
                    </div>
                    
                    <div>
                        <label for="effective_date_from" class="block text-sm font-medium text-gray-700">{{ __('Effective From') }}</label>
                        <input type="date" id="effective_date_from" name="effective_date_from" value="{{ $effectiveDateFrom }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-sm">
                    </div>
                    
                    <div>
                        <label for="effective_date_to" class="block text-sm font-medium text-gray-700">{{ __('Effective To') }}</label>
                        <input type="date" id="effective_date_to" name="effective_date_to" value="{{ $effectiveDateTo }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-sm">
                    </div>
                    ...
                    <div class="flex items-end">
                        <div class="flex items-center space-x-2 w-full">
                            ...
                            <button type="submit" class="flex-1 inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                                {{ __('Filter') }}
                            </button>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <div class="flex items-center gap-2">
                                                <a href="{{ route('final-tariffs.show', $tariff) }}" class="inline-flex items-center justify-center w-9 h-9 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" title="{{ __('View') }}" aria-label="{{ __('View') }}">
                                                ...
                                                <a href="{{ route('final-tariffs.edit', $tariff) }}" class="inline-flex items-center justify-center w-9 h-9 rounded-md border border-gray-300 text-indigo-600 hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" title="{{ __('Edit') }}" aria-label="{{ __('Edit') }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
