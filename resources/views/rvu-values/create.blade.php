...
<div class="max-w-7xl mx-auto">
    <div>
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-900">Tambah RVU</h2>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div class="px-4 py-5 sm:p-6">
                <form action="{{ route('rvu-values.store') }}" method="POST" id="rvu-form">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-12">
                            ...
                            <div class="mt-1">
                                <select id="cost_reference_id" name="cost_reference_id" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700">
                                    ...
                                    @foreach($costReferences as $cr)
                                        <option value="{{ $cr->id }}" {{ old('cost_reference_id') == $cr->id ? 'selected' : '' }}>
                        ...
                        <div class="col-span-12 md:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="number" id="period_year" name="period_year" value="{{ old('period_year', $currentYear) }}" min="2020" max="2100" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700">
                                @error('period_year')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-span-12 md:col-span-3">
                            ...
                            <div class="mt-1">
                                <select id="period_month" name="period_month" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700">
                                    ...
                                    @for($i = 1; $i <= 12; $i++)
                                        <option value="{{ $i }}" {{ old('period_month', $currentMonth) == $i ? 'selected' : '' }}>
                        ...
                        <div class="col-span-12 md:col-span-4">
                            ...
                            <div class="mt-1">
                                <input type="number" id="time_factor" name="time_factor" value="{{ old('time_factor') }}" min="1" step="1" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700" onchange="calculateRvu()">
                                @error('time_factor')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="col-span-12 md:col-span-4">
                            ...
                            <div class="mt-1">
                                <select id="professionalism_factor" name="professionalism_factor" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700" onchange="calculateRvu()">
                                    ...
                                    <option value="1" {{ old('professionalism_factor') == '1' ? 'selected' : '' }}>1 - Perawat</option>
                                    <option value="2" {{ old('professionalism_factor') == '2' ? 'selected' : '' }}>2 - Nurse/Bidan</option>
                                    <option value="3" {{ old('professionalism_factor') == '3' ? 'selected' : '' }}>3 - Dokter Umum</option>
                                    <option value="4" {{ old('professionalism_factor') == '4' ? 'selected' : '' }}>4 - Dokter Spesialis</option>
                                    <option value="5" {{ old('professionalism_factor') == '5' ? 'selected' : '' }}>5 - Dokter Subspesialis</option>
                                </select>
                        ...
                        <div class="col-span-12 md:col-span-4">
                            ...
                            <div class="mt-1">
                                <input type="number" id="difficulty_factor" name="difficulty_factor" value="{{ old('difficulty_factor') }}" min="1" max="10" step="1" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700" onchange="calculateRvu()">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="normalization_factor" name="normalization_factor" value="{{ old('normalization_factor', '1.0') }}" min="0.1" max="10.0" step="0.1" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700" onchange="calculateRvu()">
                        ...
                        <div class="col-span-12">
                            ...
                            <div class="mt-1">
                                <textarea id="notes" name="notes" rows="3" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 resize-y">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-span-12">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="rounded border-gray-300 text-biru-dongker-600 shadow-sm focus:border-biru-dongker-300 focus:ring focus:ring-biru-dongker-200 focus:ring-opacity-50">
