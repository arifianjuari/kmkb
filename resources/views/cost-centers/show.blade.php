    ...
    <div>
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('cost-centers.edit', $costCenter) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-biru-dongker-800 hover:bg-biru-dongker-900">
                    {{ __('Edit') }}
                </a>
                ...
                <div class="px-4 py-5 sm:p-6">
                    <ul class="divide-y divide-gray-200">
                        @foreach($costCenter->children as $child)
                            <li class="py-3">
                                <a href="{{ route('cost-centers.show', $child) }}" class="text-biru-dongker-800 hover:text-biru-dongker-950">
