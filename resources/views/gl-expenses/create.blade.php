                ...
                <form action="{{ route('gl-expenses.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-12">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="amount" name="amount" step="1000" min="0" value="{{ old('amount') }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                @error('amount')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
