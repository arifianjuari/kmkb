                    ...
                    <form action="{{ route('cases.update', $case) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" id="medical_record_number" name="medical_record_number" value="{{ old('medical_record_number', $case->medical_record_number) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('medical_record_number') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" id="patient_id" name="patient_id" value="{{ old('patient_id', $case->patient_id) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('patient_id') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                                @error('patient_id')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 mt-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="date" id="admission_date" name="admission_date" value="{{ old('admission_date', $case->admission_date->format('Y-m-d')) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('admission_date') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 mt-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="date" id="discharge_date" name="discharge_date" value="{{ old('discharge_date', $case->discharge_date ? $case->discharge_date->format('Y-m-d') : '') }}" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('discharge_date') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" id="primary_diagnosis" name="primary_diagnosis" value="{{ old('primary_diagnosis', $case->primary_diagnosis) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('primary_diagnosis') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 mt-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="number" id="actual_total_cost" name="actual_total_cost" step="0.01" min="0" value="{{ old('actual_total_cost', $case->actual_total_cost) }}" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('actual_total_cost') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
