...
<section class="mx-auto py-6 sm:px-6 lg:px-8">
    <div>
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Edit Patient Case') }}</h2>
                    ...
                    <form action="{{ route('cases.update', $case) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" id="medical_record_number" name="medical_record_number" value="{{ old('medical_record_number', $case->medical_record_number) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('medical_record_number') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" id="patient_id" name="patient_id" value="{{ old('patient_id', $case->patient_id) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('patient_id') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                                @error('patient_id')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 mt-6">
                                ...
                                <div class="mt-1">
                                    <select id="clinical_pathway_id" name="clinical_pathway_id" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('clinical_pathway_id') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                        ...
                                        @foreach($pathways as $pathway)
                                            <option value="{{ $pathway->id }}" {{ old('clinical_pathway_id', $case->clinical_pathway_id) == $pathway->id ? 'selected' : '' }}>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="date" id="admission_date" name="admission_date" value="{{ old('admission_date', $case->admission_date->format('Y-m-d')) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('admission_date') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 mt-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="date" id="discharge_date" name="discharge_date" value="{{ old('discharge_date', $case->discharge_date ? $case->discharge_date->format('Y-m-d') : '') }}" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('discharge_date') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" id="primary_diagnosis" name="primary_diagnosis" value="{{ old('primary_diagnosis', $case->primary_diagnosis) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('primary_diagnosis') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-1">
                                <textarea id="annotation" name="annotation" rows="3" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('annotation') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="{{ __('Catatan atau komentar atas kasus yang dinilai') }}">{{ old('annotation', $case->annotation) }}</textarea>
                            </div>
                            @error('annotation')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 mt-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="number" id="actual_total_cost" name="actual_total_cost" step="0.01" min="0" value="{{ old('actual_total_cost', $case->actual_total_cost) }}" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('actual_total_cost') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="number" id="ina_cbg_tariff" name="ina_cbg_tariff" step="0.01" min="0" value="{{ old('ina_cbg_tariff', $case->ina_cbg_tariff) }}" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-biru-dongker-700 focus:border-biru-dongker-700 @error('ina_cbg_tariff') border-red-500 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // If code already has value (editing existing case), auto-fetch tariff on load
