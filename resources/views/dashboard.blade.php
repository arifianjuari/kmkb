                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold">{{ $totalPathways }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold">{{ number_format($averageCompliance ?? 0, 2) }}%</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold">Rp{{ number_format($totalCostVariance ?? 0, 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($recentCases as $case)
                                            ...
                                            <tr class="hover:bg-gray-50">
                                                <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-900">{{ $case->medical_record_number }}</td>
                                                <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-900">{{ $case->clinicalPathway->name ?? '-' }}</td>
                                                <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-900">{{ optional($case->admission_date)->format('d M Y') }}</td>
                                ...
                                @foreach($casesByPathway as $data)
                                    <li>
                                        <div class="flex items-center justify-between mb-1">
                                            <span class="text-sm font-medium text-gray-700">{{ $data->pathway_name }}</span>
