...
<div class="mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('reports.index') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                {{ __('Back to Reports') }}
            </a>
        </div>
                    ...
                    <form method="GET" action="{{ route('reports.cost-variance') }}">
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1">
                                    <input type="date" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="date_from" name="date_from" value="{{ request('date_from', now()->subMonth()->format('Y-m-d')) }}">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1">
                                    <input type="date" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="date_to" name="date_to" value="{{ request('date_to', now()->format('Y-m-d')) }}">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1">
                                    <select id="variance_range" name="variance_range" class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            ...
                            <a href="{{ route('reports.cost-variance') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                {{ __('Clear') }}
                            </a>
                        </div>
                    </form>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('Standard Cost') }}</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($cases as $case)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ number_format($case->total_charges, 2) }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ number_format($case->standard_cost, 2) }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm {{ $case->cost_variance >= 0 ? 'text-red-600' : 'text-green-600' }}">
                                                {{ number_format($case->cost_variance, 2) }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm {{ $case->cost_variance_percentage >= 0 ? 'text-red-600' : 'text-green-600' }}">
