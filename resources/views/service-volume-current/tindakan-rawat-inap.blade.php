...
@section('title', 'Service Volume (Current) - Tindakan Rawat Inap')
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form method="GET" class="grid gap-6 md:grid-cols-4">
            ...
            <div>
                ...
                <select id="bangsal" name="bangsal[]" multiple class="w-full h-36 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div class="flex items-end space-x-2">
                ...
                <button type="submit"
                        formaction="{{ route('svc-current.tindakan-rawat-inap.export') }}"
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900">Rekap Tindakan Rawat Inap</h2>
