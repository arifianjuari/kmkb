...
@section('title', 'Service Volume (Current) - Operasi')
...
<div class="max-w-7xl mx-auto space-y-6">
    <div class="bg-white shadow rounded-lg p-6">
        <form method="GET" class="grid gap-6 md:grid-cols-4">
            ...
            <div>
                <label for="search" class="block text-sm font-medium text-gray-700 mb-1">Cari Nama Operasi</label>
                <input type="text" id="search" name="search" value="{{ $search }}" placeholder="Nama operasi..." class="w-full rounded-md border-gray-300 shadow-sm focus:border-biru-dongker-700 focus:ring-biru-dongker-700">
            </div>
            <div class="flex items-end space-x-2 md:col-span-4">
                ...
                <button type="submit"
                        formaction="{{ route('svc-current.operasi.export') }}"
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900">Rekap Operasi</h2>
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3 text-left font-semibold text-gray-700">Tindakan Operasi</th>
                        ...
                        @endforeach
                        <th scope="col" class="px-4 py-3 text-center font-semibold text-gray-700 bg-rose-50">Total Jumlah Operasi</th>
                        <th scope="col" class="px-4 py-3 text-right font-semibold text-gray-700 bg-rose-50">Total Pendapatan (Rp)</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    @forelse($operasiData as $row)
                    ...
                    @empty
                        <tr>
                            <td colspan="17" class="px-4 py-6 text-center text-gray-500">Belum ada data operasi untuk filter yang dipilih.</td>
                        </tr>
                    @endforelse
                </tbody>
                @if(count($operasiData) > 0)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    syncButton.addEventListener('click', function() {
        ...
        fetch('{{ route("svc-current.operasi.sync") }}', {
            method: 'POST',
