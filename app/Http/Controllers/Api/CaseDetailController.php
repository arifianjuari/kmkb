...
class CaseDetailController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return response()->json(['error' => 'Failed to load case details: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json(['error' => 'Failed to create case detail: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function show(CaseDetail $caseDetail)
    {
        try {
            ...
            return response()->json(['error' => 'Failed to load case detail: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function update(Request $request, CaseDetail $caseDetail)
    {
        try {
            ...
            return response()->json(['error' => 'Failed to update case detail: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function destroy(CaseDetail $caseDetail)
    {
        try {
            ...
            return response()->json(['error' => 'Failed to delete case detail: ' . $e->getMessage()], 500);
        }
    }
}
