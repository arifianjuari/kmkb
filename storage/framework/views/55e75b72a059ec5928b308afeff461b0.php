<?php $__env->startSection('title', 'SIMRS Kamar'); ?>
    ...
    <div class="px-4 py-6 sm:px-0">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-2">
                <div class="relative">
                    <input type="text" id="search-kamar" placeholder="Cari kode kamar, bangsal, atau kelas..." class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm pl-10">
    ...
    function renderKamarTable(data, total) {
        ...
        data.forEach(item => {
            ...
            rows += `
                <tr>
                    <td class="px-4 py-4">
                        <input type="checkbox" class="row-checkbox h-4 w-4 text-indigo-600 border-gray-300 rounded" data-kode="${item.kd_kamar}" data-nama="${item.kd_bangsal} - ${item.kelas}" data-harga="${item.trf_kamar}">
                    </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/kmkb/resources/views/simrs/kamar.blade.php ENDPATH**/ ?>