<?php $__env->startSection('title', 'Edit Case Detail'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
    <h2 class="text-xl font-bold mb-4">Edit Case Detail for <?php echo e($case->patient_name); ?></h2>
    
    <form action="<?php echo e(route('cases.details.update', [$case, $detail])); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        
        <div class="mb-4">
            <label class="inline-flex items-center">
                <input type="checkbox" id="custom_step_toggle" name="is_custom_step" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="1" <?php echo e($detail->isCustomStep() ? 'checked' : ''); ?>>
                ...
                <select name="pathway_step_id" id="pathway_step_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    ...
                    <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($step->id); ?>" 
                                ...
                                <?php echo e((old('pathway_step_id') ?? $detail->pathway_step_id) == $step->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="service_item" id="service_item" value="<?php echo e(old('service_item') ?? $detail->service_item); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="service_code" id="service_code" value="<?php echo e(old('service_code') ?? $detail->service_code); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select name="status" id="status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    <option value="pending" <?php echo e((old('status') ?? $detail->status) == 'pending' ? 'selected' : ''); ?>>Belum Dilakukan</option>
                    <option value="completed" <?php echo e((old('status') ?? $detail->status) == 'completed' ? 'selected' : ''); ?> selected>Sudah Dilakukan</option>
                    <option value="skipped" <?php echo e((old('status') ?? $detail->status) == 'skipped' ? 'selected' : ''); ?>>Dilewati</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="checkbox" name="performed" id="performed" value="1" <?php echo e((old('performed') ?? $detail->performed) ? 'checked' : ''); ?> class="mt-1 rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="quantity" id="quantity" value="<?php echo e(old('quantity') ?? $detail->quantity); ?>" min="1"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="actual_cost" id="actual_cost" value="<?php echo e(old('actual_cost') ?? $detail->actual_cost); ?>" min="0"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="date" name="service_date" id="service_date" value="<?php echo e(old('service_date') ?? ($detail->service_date ? \Carbon\Carbon::parse($detail->service_date)->format('Y-m-d') : date('Y-m-d'))); ?>"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/kmkb/resources/views/cases/details/edit.blade.php ENDPATH**/ ?>