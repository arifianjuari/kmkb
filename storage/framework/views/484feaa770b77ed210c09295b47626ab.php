...
<?php endif; ?>
    ...
    <nav class="flex-1 overflow-y-auto py-2 px-2 bg-gray-200">
        <?php if(auth()->guard()->check()): ?>
            ...
            <?php if(!$isSuperadmin): ?>
                <!-- Setup Group -->
                <?php if(MenuHelper::canAccessMenu($user, 'setup')): ?>
                    <div class="mb-0.5">
                ...
                <!-- Data Input Group -->
                <?php if(MenuHelper::canAccessMenu($user, 'data-input')): ?>
                    <div class="mb-0.5">
                        ...
                        <div x-show="!collapsed && isGroupOpen('data-input')" class="ml-8 mt-0.5 space-y-0.5">
                            ...
                            <div class="mt-0.5" x-show="!collapsed">
                                <button @click="toggleGroup('svc-simrs')"
                                        class="w-full flex items-center justify-between px-3 py-1.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('svc-current.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                ...
                                <div x-show="isGroupOpen('svc-simrs')" class="ml-4 mt-0.5 space-y-0.5">
                                    ...
                                    <a href="<?php echo e(route('svc-current.tindakan-rawat-inap')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('svc-current.tindakan-rawat-inap') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Tindakan Rawat Inap</span>
                                    </a>
                                    <a href="<?php echo e(route('svc-current.laboratorium')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('svc-current.laboratorium') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Laboratorium</span>
                                    </a>
                                    <a href="<?php echo e(route('svc-current.radiologi')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('svc-current.radiologi') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                            ...
                            <div class="mt-0.5" x-show="!collapsed">
                                <button @click="toggleGroup('fixed-assets')"
                                        class="w-full flex items-center justify-between px-3 py-1.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('asset-categories.*') || request()->routeIs('fixed-assets.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                ...
                                <div x-show="isGroupOpen('fixed-assets')" class="ml-4 mt-0.5 space-y-0.5">
                                    <a href="<?php echo e(route('fixed-assets.dashboard')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('fixed-assets.dashboard') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Dashboard</span>
                                    </a>
                                    <a href="<?php echo e(route('asset-categories.index')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('asset-categories.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Asset Categories</span>
                                    </a>
                                    <a href="<?php echo e(route('fixed-assets.index')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('fixed-assets.index') || request()->routeIs('fixed-assets.create') || request()->routeIs('fixed-assets.edit') || request()->routeIs('fixed-assets.show') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Asset Register</span>
                                    </a>
                                    <a href="<?php echo e(route('fixed-assets.depreciation')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('fixed-assets.depreciation') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Depreciation Calculator</span>
                                    </a>
                                    <a href="<?php echo e(route('fixed-assets.depreciation-report')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('fixed-assets.depreciation-report') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                            ...
                            <div class="mt-0.5" x-show="!collapsed">
                                <button @click="toggleGroup('service-fees')"
                                        class="w-full flex items-center justify-between px-3 py-1.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('service-fees.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                ...
                                <div x-show="isGroupOpen('service-fees')" class="ml-4 mt-0.5 space-y-0.5">
                                    <a href="<?php echo e(route('service-fees.revenue-sources.index')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('service-fees.revenue-sources.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Sumber Pendapatan</span>
                                    </a>
                                    <a href="<?php echo e(route('service-fees.revenue-records.index')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('service-fees.revenue-records.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Import Pendapatan</span>
                                    </a>
                                    <a href="<?php echo e(route('service-fees.configs.index')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('service-fees.configs.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Konfigurasi Jasa</span>
                                    </a>
                                    <a href="<?php echo e(route('service-fees.indexes.index')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('service-fees.indexes.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Indeks Jasa</span>
                                    </a>
                                    <a href="<?php echo e(route('service-fees.assignments.index')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('service-fees.assignments.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                                        <span class="truncate">Penugasan Jasa</span>
                                    </a>
                                    <a href="<?php echo e(route('service-fees.calculations.form')); ?>"
                                       class="flex items-center px-3 py-1.5 text-xs rounded-lg transition-colors <?php echo e(request()->routeIs('service-fees.calculations.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                ...
                <!-- Costing Process Group -->
                <?php if(MenuHelper::canAccessMenu($user, 'costing-process')): ?>
                    <div class="mb-0.5">
                ...
                <!-- Tariff Management Group -->
                <?php if(MenuHelper::canAccessMenu($user, 'tariffs')): ?>
                    <div class="mb-0.5">
                ...
                <!-- Clinical Pathways -->
                <?php if(MenuHelper::canAccessMenu($user, 'pathways')): ?>
                <div class="mb-1">
                ...
                <!-- Patient Cases -->
                <?php if(MenuHelper::canAccessMenu($user, 'cases')): ?>
                <div class="mb-1">
                ...
                <?php if(MenuHelper::canAccessMenu($user, 'analytics')): ?>
                <div class="mb-1">
                ...
                <div class="mb-0.5">
                    <button @click="toggleGroup('other-output')" 
                        ...
                        <div class="flex items-center">
                            ...
                            <span x-show="!collapsed" class="truncate"><?php echo e(__('Other Output')); ?></span>
                        </div>
                    ...
                    <div x-show="!collapsed && isGroupOpen('other-output')" class="ml-8 mt-0.5 space-y-0.5">
                        <a href="<?php echo e(route('locations.index')); ?>" 
                           class="flex items-center px-3 py-1.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('locations.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                            <span class="truncate"><?php echo e(__('Location')); ?></span>
                        </a>
                        <a href="<?php echo e(route('expense-breakdown.index')); ?>" 
                           class="flex items-center px-3 py-1.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('expense-breakdown.*') ? 'bg-biru-dongker-800 text-white' : 'text-gray-600 hover:bg-gray-300 hover:text-gray-900'); ?>">
                            <span class="truncate"><?php echo e(__('Rekap Pengeluaran')); ?></span>
                        </a>
                    </div>
                </div>

                <!-- SIMRS Integration Group -->
                <?php if(MenuHelper::canAccessMenu($user, 'simrs')): ?>
                    <div class="mb-0.5">
                ...
                <?php if(MenuHelper::canAccessMenu($user, 'references')): ?>
