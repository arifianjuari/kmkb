...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="scroll-smooth">
    ...
    <body class="antialiased text-slate-800 bg-slate-50 selection:bg-indigo-500 selection:text-white">
        ...
        <nav class="fixed w-full z-50 top-0 transition-all duration-300 bg-white/80 backdrop-blur-md border-b border-slate-200/60">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="flex items-center gap-2 cursor-pointer" onclick="window.scrollTo({top: 0, behavior: 'smooth'})">
                        <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-600 to-blue-500 flex items-center justify-center text-white font-bold">K</div>
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="#benefit" class="text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors">Manfaat</a>
                        <a href="#about" class="text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors">Tentang</a>
                    </div>
                    ...
                    <div class="hidden md:flex items-center space-x-4">
                        <?php if(Route::has('login')): ?>
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(url('/dashboard')); ?>" class="text-sm font-medium text-slate-700 hover:text-indigo-600 transition-colors">Dashboard</a>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-slate-700 hover:text-indigo-600 transition-colors">Log in</a>
                                <a href="<?php echo e(route('register')); ?>" class="btn btn-primary rounded-full">
                                    Get Started
                                </a>
                            <?php endif; ?>
                        <?php endif; ?>
                    ...
                    <!-- Mobile Menu Button -->
                    <div class="md:hidden">
                        <button id="mobile-menu-btn" class="text-slate-700 hover:text-indigo-600 p-2">
            ...
            <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-slate-100 absolute w-full shadow-xl">
                <div class="px-6 py-6 space-y-4">
                    ...
                    <?php if(Route::has('login')): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="block text-base font-medium text-indigo-600">Dashboard</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="block text-base font-medium text-slate-700">Log in</a>
                            <a href="<?php echo e(route('register')); ?>" class="block w-full px-6 py-3 text-center text-base font-medium text-white bg-indigo-600 rounded-lg">Get Started</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <!-- Hero Section -->
        <section class="relative pt-24 pb-16 lg:pt-32 lg:pb-20 overflow-hidden bg-gradient-to-b from-white via-indigo-50/20 to-white">
            <!-- Background Elements -->
            <div class="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-indigo-500 rounded-full mix-blend-multiply filter blur-3xl opacity-25 animate-blob"></div>
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-8 relative">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <!-- Hero Content -->
                    <div class="max-w-2xl">
                        <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-indigo-100 to-blue-100 border border-indigo-200 text-indigo-700 text-xs font-bold uppercase tracking-wide mb-5">
                        ...
                        <h1 class="text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 mb-5 leading-snug">
                            Kendali mutu, <br>
                            <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-indigo-700 to-blue-600">kendali biaya.</span>
                        </h1>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(url('/dashboard')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-semibold text-white bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-full shadow-xl shadow-indigo-500/30 hover:shadow-indigo-600/50 hover:from-indigo-700 hover:to-indigo-800 transform hover:-translate-y-1 transition-all duration-200">
                                    Akses Dashboard
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-semibold text-white bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-full shadow-xl shadow-indigo-500/30 hover:shadow-indigo-600/50 hover:from-indigo-700 hover:to-indigo-800 transform hover:-translate-y-1 transition-all duration-200">
                                    Mulai Sekarang
                                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
                                </a>
                                <a href="#features" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-semibold text-indigo-700 bg-white hover:bg-indigo-50 border-2 border-indigo-200 hover:border-indigo-300 rounded-full shadow-sm transition-all duration-200">
                                    Pelajari Fitur
                                </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="relative lg:h-[640px] flex items-center justify-center perspective-1000">
                        <div class="relative w-full max-w-[600px] transform rotate-y-[-5deg] rotate-x-[2deg] hover:rotate-0 transition-transform duration-700 ease-out z-10">
                            <!-- Main Window -->
                            <div class="bg-white rounded-3xl shadow-2xl shadow-indigo-500/20 border-[6px] border-slate-900/10 overflow-hidden ring-4 ring-indigo-100/50">
                                <!-- Window Header -->
                                ...
                                <div class="flex h-[400px]">
                                    ...
                                    <div class="w-16 bg-slate-900 flex flex-col items-center py-6 gap-6 border-r border-slate-800">
                                        <div class="w-8 h-8 rounded bg-indigo-500 flex items-center justify-center text-white font-bold text-xs">K</div>
                                        ...
                                        <div class="w-6 h-6 text-indigo-400 cursor-pointer"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg></div>
                                        ...
                                        <div class="bg-white p-5 rounded-xl border border-slate-100 shadow-sm h-40 relative">
                                            ...
                                            <div class="flex items-end justify-between h-24 px-2 gap-3">
                                                ...
                                                <div class="w-full flex gap-1 items-end h-full">
                                                    ...
                                                    <div class="w-full bg-indigo-500 rounded-t h-[30%]"></div>
                                                </div>
                                                <!-- Bar Group 2 -->
                                                <div class="w-full flex gap-1 items-end h-full">
                                                    <div class="w-full bg-indigo-100 rounded-t h-[60%]"></div>
                                                    <div class="w-full bg-indigo-500 rounded-t h-[45%]"></div>
                                                </div>
                                                <!-- Bar Group 3 -->
                                                <div class="w-full flex gap-1 items-end h-full">
                                                    <div class="w-full bg-indigo-100 rounded-t h-[50%]"></div>
                                                    <div class="w-full bg-indigo-500 rounded-t h-[40%]"></div>
                                                </div>
                                                <!-- Bar Group 4 -->
                                                <div class="w-full flex gap-1 items-end h-full">
                                                    <div class="w-full bg-indigo-100 rounded-t h-[80%]"></div>
                                                    <div class="w-full bg-indigo-500 rounded-t h-[65%]"></div>
                                                </div>
                                                <!-- Bar Group 5 -->
                                                <div class="w-full flex gap-1 items-end h-full">
                                                    <div class="w-full bg-indigo-100 rounded-t h-[75%]"></div>
                                                    <div class="w-full bg-indigo-500 rounded-t h-[60%]"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!-- Features Section -->
        <section id="features" class="py-20 bg-gradient-to-b from-white via-indigo-50/30 to-white relative">
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                <div class="text-center max-w-3xl mx-auto mb-12">
                    <h2 class="text-xs font-bold text-indigo-700 uppercase tracking-wider mb-3">Platform Features</h2>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Feature 1 -->
                    <div class="bg-white p-8 rounded-3xl shadow-xl shadow-slate-200/60 border-2 border-slate-100 hover:border-indigo-300 transition-all hover:-translate-y-2 group">
                    ...
                    <!-- Feature 3 -->
                    <div class="bg-white p-8 rounded-3xl shadow-xl shadow-slate-200/60 border-2 border-slate-100 hover:border-indigo-300 transition-all hover:-translate-y-2 group">
                        <div class="w-14 h-14 bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-2xl flex items-center justify-center mb-6 text-white shadow-lg shadow-indigo-500/30 group-hover:scale-110 transition-transform duration-300">
        ...
        <!-- Stats/Proof Section -->
        <section class="py-16 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white relative overflow-hidden border-t border-indigo-900/50">
            <div class="absolute top-0 left-0 w-full h-full overflow-hidden z-0 opacity-30">
                <div class="absolute -top-[50%] -left-[50%] w-[200%] h-[200%] bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-indigo-900 via-slate-900 to-slate-900 animate-spin-slow"></div>
            </div>
            <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                <div class="grid md:grid-cols-3 gap-12 text-center">
                    <div>
                        <div class="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-blue-400 mb-2">30%</div>
                    ...
                    <div>
                        <div class="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400 mb-2">< 1%</div>
        ...
        <section class="py-20 bg-gradient-to-b from-white to-slate-50 border-t border-slate-200">
            <div class="max-w-5xl mx-auto px-6 lg:px-8">
                <div class="bg-gradient-to-r from-indigo-600 via-indigo-700 to-blue-600 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden shadow-2xl shadow-indigo-500/40">
                    <!-- Decorative circles -->
                    ...
                    <p class="text-indigo-100 text-lg mb-8 max-w-2xl mx-auto relative z-10 leading-normal">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-bold text-indigo-700 bg-white hover:bg-indigo-50 rounded-full shadow-xl border-none transition-all duration-200 transform hover:-translate-y-1">
                                Kembali ke Dashboard
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-bold text-indigo-700 bg-white hover:bg-indigo-50 rounded-full shadow-xl border-none transition-all duration-200 transform hover:-translate-y-1">
                                Mulai Sekarang
                            </a>
        ...
        <!-- Footer -->
        <footer class="bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 border-t-2 border-indigo-900/50 pt-16 pb-10 text-slate-400">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                    <div class="col-span-1 lg:col-span-1">
                        <div class="flex items-center gap-2 mb-5">
                            <div class="w-9 h-9 rounded-lg bg-gradient-to-br from-indigo-600 to-blue-500 flex items-center justify-center text-white font-bold text-base">K</div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2.5 text-sm">
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Fitur Utama</a></li>
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Studi Kasus</a></li>
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Harga</a></li>
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Enterprise</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2.5 text-sm">
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Tentang Kami</a></li>
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Karir</a></li>
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Blog</a></li>
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Kontak</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2.5 text-sm">
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Kebijakan Privasi</a></li>
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Syarat & Ketentuan</a></li>
                            <li><a href="#" class="text-slate-400 hover:text-indigo-400 transition-colors inline-block">Keamanan Data</a></li>
                        </ul>
                    </div>
                </div>
                
                <div class="pt-6 border-t border-slate-800/80 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p class="text-sm text-slate-500">&copy; <?php echo e(date('Y')); ?> KMKB System. All rights reserved.</p>
                    <div class="flex gap-6">
                        <a href="#" class="text-slate-500 hover:text-indigo-400 transition-colors p-2 hover:bg-slate-800 rounded-lg">
...
<?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/kmkb/resources/views/welcome.blade.php ENDPATH**/ ?>