...
<div class="mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        ...
        <div class="mb-6 md:grid md:grid-cols-12 md:gap-6">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg md:col-span-8">
                <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                    <h3 class="text-lg leading-6 font-medium text-gray-900"><?php echo e(__('Add New Step')); ?></h3>
                </div>
                <div class="px-4 py-5 sm:p-6">
                    <form id="step-form" method="POST" action="<?php echo e(route('pathways.steps.store', $pathway)); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-12">
                            <div class="sm:col-span-2">
                                <label for="day" class="block text-sm font-medium text-gray-700"><?php echo e(__('Day')); ?></label>
                                <div class="mt-1">
                            ...
                            <div class="sm:col-span-4">
                                <label for="category" class="block text-sm font-medium text-gray-700"><?php echo e(__('Category')); ?></label>
                                <div class="mt-1">
                            ...
                            <div class="sm:col-span-5">
                                <label for="activity" class="block text-sm font-medium text-gray-700"><?php echo e(__('Activity')); ?></label>
                                <div class="mt-1">
                                    <input type="text" id="activity" name="activity" list="activityList" placeholder="<?php echo e(__('Type to search service code')); ?>" required class="py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                    <datalist id="activityList">
                                        <?php $__currentLoopData = $costReferences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reference): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($reference->service_code); ?>"><?php echo e($reference->service_description); ?></option>
                                    ...
                                    <div id="no-match-add-ref" class="mt-2 hidden text-left">
                                        <button type="button" id="open-add-ref" class="text-xs text-indigo-600 hover:text-indigo-800">
                                            <?php echo e(__('Tidak menemukan hasil? Tambah referensi biaya baru')); ?>
                            ...
                            <div class="sm:col-span-2">
                                <label for="quantity" class="block text-sm font-medium text-gray-700"><?php echo e(__('Quantity')); ?></label>
                                <div class="mt-1">
                            ...
                            <div class="sm:col-span-2">
                                <label for="total_cost_display" class="block text-sm font-medium text-gray-700"><?php echo e(__('Total Cost')); ?></label>
                                <div class="mt-1">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg mt-6 md:mt-0 md:col-span-4">
                <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                    <h3 class="text-lg leading-6 font-medium text-gray-900"><?php echo e(__('Bulk Import Steps')); ?></h3>
                </div>
                <div class="px-4 py-5 sm:p-6">
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(route('pathways.steps.template', $pathway)); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <?php echo e(__('Download Excel Template')); ?>

                        </a>
                    </div>
                    <form class="mt-4" method="POST" action="<?php echo e(route('pathways.steps.import', $pathway)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="space-y-3">
                        ...
                        <p class="mt-2 text-sm text-gray-500"><?php echo e(__('Kolom: day, activity, description, criteria, standard_cost, quantity, cost_reference_id. Total cost akan dihitung otomatis (standard_cost x quantity). Anda dapat mengisi dari template Excel lalu upload file Excel/CSV.')); ?></p>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                <h3 class="text-lg leading-6 font-medium text-gray-900"><?php echo e(__('Pathway Steps')); ?></h3>
            </div>
            <div class="px-4 py-5 sm:p-6">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Day')); ?></th>
                                    <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Category')); ?></th>
                                    <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Service Code')); ?></th>
                                    <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Description')); ?></th>
                                    <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Criteria')); ?></th>
                                    <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Standard Cost')); ?></th>
                                    <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Quantity')); ?></th>
                                    <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Total Cost')); ?></th>
                                    <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Actions')); ?></th>
                                    <th class="px-6 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Cost Reference')); ?></th>
                                </tr>
                            </thead>
                            <tbody id="steps-tbody" class="bg-white divide-y divide-gray-200">
                                ...
                                ?>
                                <?php $__currentLoopData = $stepsSorted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr data-step-id="<?php echo e($step->id); ?>">
                                        <td class="px-2 py-2 text-gray-400 cursor-move drag-handle" title="Drag to reorder">☰</td>
                                        <td contenteditable="true" data-field="day" class="px-6 py-2 whitespace-nowrap text-xs text-gray-900"><?php echo e($step->step_order); ?></td>
                                        <td contenteditable="true" data-field="category" class="px-6 py-2 whitespace-nowrap text-xs text-gray-900"><?php echo e($step->category); ?></td>
                                        <td contenteditable="true" data-field="activity" class="px-6 py-2 whitespace-nowrap text-xs text-gray-900"><?php echo e($step->service_code); ?></td>
                                        <td contenteditable="true" data-field="description" class="px-6 py-2 text-xs text-gray-900"><?php echo e($step->description); ?></td>
                                        <td contenteditable="true" data-field="criteria" class="px-6 py-2 text-xs text-gray-900"><?php echo e($step->criteria); ?></td>
                                        <td contenteditable="true" data-field="standard_cost" class="px-6 py-2 whitespace-nowrap text-xs text-gray-900"><?php echo e(number_format($step->estimated_cost, 0, ',', '.')); ?></td>
                                        <td contenteditable="true" data-field="quantity" class="px-6 py-2 whitespace-nowrap text-xs text-gray-900"><?php echo e(number_format($step->quantity, 0, ',', '.')); ?></td>
                                        <td data-field="total_cost" class="px-6 py-2 whitespace-nowrap text-xs text-gray-900"><?php echo e(number_format($step->total_cost, 0, ',', '.')); ?></td>
                                        <td class="px-6 py-2 whitespace-nowrap text-xs">
                                            <button class="save-step inline-flex items-center p-1.5 border border-transparent rounded text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" data-step-id="<?php echo e($step->id); ?>" aria-label="<?php echo e(__('Save')); ?>" title="<?php echo e(__('Save')); ?>">
                                                ...
                                                <span class="sr-only"><?php echo e(__('Save')); ?></span>
                                            </button>
                                            <form action="<?php echo e(route('pathways.steps.destroy', [$pathway, $step])); ?>" method="POST" class="inline ml-2">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="submit" class="inline-flex items-center p-1.5 border border-transparent rounded text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" onclick="return confirm('<?php echo e(__('Are you sure you want to delete this step?')); ?>')" aria-label="<?php echo e(__('Delete')); ?>" title="<?php echo e(__('Delete')); ?>">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4" aria-hidden="true">
                                                        <path d="M6 7h12" />
                                        ...
                                        <td class="px-6 py-2 whitespace-nowrap text-xs text-gray-900">
                                            <select class="cost-reference-select py-1 px-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" data-step-id="<?php echo e($step->id); ?>">
                                                <option value=""><?php echo e(__('None')); ?></option>
                                                <?php $__currentLoopData = $costReferences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reference): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($reference->id); ?>" data-cost="<?php echo e(number_format($reference->standard_cost, 0, '.', '')); ?>" data-code="<?php echo e($reference->service_code); ?>" data-desc="<?php echo e($reference->service_description); ?>" <?php echo e($step->cost_reference_id == $reference->id ? 'selected' : ''); ?>>
                                                        <?php echo e($reference->service_description); ?> (Rp<?php echo e(number_format($reference->standard_cost, 0, ',', '.')); ?>)
                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </td>
                ...
                <div class="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <div class="flex justify-between items-center">
                        <h4 class="text-lg font-medium text-gray-900"><?php echo e(__('Total Pathway Cost')); ?></h4>
                        <div class="text-2xl font-bold text-indigo-600" id="total-pathway-cost">
                            Rp<?php echo e(number_format($pathway->steps->sum('total_cost'), 0, ',', '.')); ?>
        ...
        <div class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
            <div class="sm:flex sm:items-start">
                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title"><?php echo e(__('Tambah Referensi Biaya')); ?></h3>
                    <div class="mt-4">
                        <form id="add-ref-form">
                            <div class="grid grid-cols-1 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700"><?php echo e(__('Service Name')); ?></label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700"><?php echo e(__('Description')); ?></label>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700"><?php echo e(__('Unit')); ?></label>
                                        <input type="text" id="ref_unit" placeholder="<?php echo e(__('e.g. kali / tindakan')); ?>" required class="mt-1 py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700"><?php echo e(__('Source')); ?></label>
                                        <input type="text" id="ref_source" placeholder="<?php echo e(__('e.g. internal')); ?>" required class="mt-1 py-2 px-3 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                    </div>
                                </div>
            ...
            <div class="mt-5 sm:mt-6 sm:flex sm:flex-row-reverse">
                <button type="button" id="save-add-ref" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm"><?php echo e(__('Simpan')); ?></button>
                <button type="button" id="cancel-add-ref" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none sm:mt-0 sm:w-auto sm:text-sm"><?php echo e(__('Batal')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('step-form').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route('pathways.steps.store', $pathway)); ?>', {
                method: 'POST',
                body: formData,
                headers: {
        ...
        const costRefMap = {
<?php $__currentLoopData = $costReferences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reference): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            "<?php echo e($reference->service_code); ?>": { id: <?php echo e($reference->id); ?>, cost: "<?php echo e(number_format($reference->standard_cost, 0, '.', '')); ?>", desc: <?php echo json_encode($reference->service_description, 15, 512) ?> },
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        };
        ...
        async function submitAddRef() {
            ...
            try {
                ...
                const resp = await fetch('<?php echo e(route('cost-references.store')); ?>', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                        'Accept': 'application/json',
        ...
        document.querySelectorAll('.save-step').forEach(button => {
            button.addEventListener('click', function() {
                ...
                fetch(`/pathways/<?php echo e($pathway->id); ?>/steps/${stepId}`, {
                    method: 'PUT',
        ...
        if (tbody && window.Sortable) {
            new Sortable(tbody, {
                ...
                onEnd: function() {
                    ...
                    fetch('<?php echo e(route('pathways.steps.reorder', $pathway)); ?>', {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                            'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arifianjuari/Library/CloudStorage/GoogleDrive-arifianjuari@gmail.com/My Drive/01 PAPA/05 DEVELOPMENT/kmkb/resources/views/pathways/builder.blade.php ENDPATH**/ ?>